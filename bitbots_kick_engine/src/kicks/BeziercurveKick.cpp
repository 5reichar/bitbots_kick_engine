...
BeziercurveKick::BeziercurveKick(std::shared_ptr<KickEngineParameter> sp_parameter)
	:Kick(sp_parameter)
{
	auto s_container = bitbots_splines::SplineContainerFactory::create_beziercurve_container();
	m_sp_spline_container = std::make_shared<bitbots_splines::SplineContainer>(s_container);
}

bool BeziercurveKick::check_requirements(KickAttributes & kick_attributes)
{
	//TODO: testing
	//TODO: cleanup
...
bool BeziercurveKick::calculate_movement_kick_preparation(double& time, struct3d &  foot_position, struct3d &  kick_start_position, bool &  kick_with_right)
{
	//TODO: testing
	//TODO: cleanup
...
void BeziercurveKick::calculate_movement_kick(double& time, struct3d &  foot_position, struct3d &  ball_position, struct3d &  kick_goal_position, bool &  kick_with_right)
{
	//TODO: testing
	//TODO: cleanup
...
void BeziercurveKick::calculate_movement_kick_conclusion(double& time, struct3d &  foot_position, struct3d &  foot_ending_position, bool &  kick_with_right)
{
	//TODO: testing
	//TODO: cleanup
