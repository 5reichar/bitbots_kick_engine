...
CubicSplineKick::CubicSplineKick(std::shared_ptr<KickEngineParameter> sp_parameter)
	:Kick(sp_parameter)
{
	auto s_container = bitbots_splines::SplineContainerFactory::create_cubic_spline_container();
