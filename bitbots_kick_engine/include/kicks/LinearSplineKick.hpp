#ifndef LINEARSPLINEKICK_HPP
#define LINEARSPLINEKICK_HPP

#include "Kick.hpp"

class [[deprecated]] LinearSplineKick : public Kick
{
public:
	LinearSplineKick(std::shared_ptr<KickEngineParameter> sp_parameter);
