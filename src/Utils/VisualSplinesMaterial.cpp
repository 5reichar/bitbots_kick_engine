...
std::vector<std::vector<bitbots_splines::Spline::Point>> VisualSplinesMaterial::get_points() const
{
    std::vector<std::vector<bitbots_splines::Spline::Point>> points;

    points.push_back(m_p_spline_x->points());
    points.push_back(m_p_spline_y->points());
    points.push_back(m_p_spline_z->points());
