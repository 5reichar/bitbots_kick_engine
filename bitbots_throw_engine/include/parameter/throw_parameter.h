...
struct ThrowParameter
{
	...
	Struct3dRPY throw_start_left_hand_axis_;
	// the rotation which the right hand should be when the throw is been started
	Struct3dRPY throw_start_right_hand_axis_;
